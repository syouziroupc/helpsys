...
assert(privacyUi.includes('AI接続先未設定。画面送信停止。音声のクラウド送信も無効です'), 'Safe unconfigured startup state must disclose that screen egress and cloud voice are disabled.');
